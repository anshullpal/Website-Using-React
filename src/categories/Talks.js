...
import talksArticles from './Posts/talksArticles';
...
const Talks = () => {
  ...
  const handleNextClick = () => {
    if (currentIndex < talksArticles.length - 1) {
      setCurrentIndex(currentIndex + 1);
    }
  };
  ...
  const containerStyle = {
    ...
    minHeight: '100vh',
    paddingTop: '80px', // Add this to create space below the fixed Navbar
  };
  ...
  return (
    <>
      ...
      <div style={containerStyle}>
        ...
        <main className="talks-main">
          <div key={talksArticles[currentIndex].id} style={articleContainerStyle} className="article-container">
            <h2 style={articleTitleStyle} className="article-title">
              {talksArticles[currentIndex].title}
            </h2>
            <p style={articleContentStyle} className="article-content">
              {talksArticles[currentIndex].content}
            </p>
          </div>
        </main>

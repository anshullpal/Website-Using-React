...
import iotArticles from './Posts/iotArticles';
...
const Iot = () => {
  ...
  const handleNextClick = () => {
    if (currentIndex < iotArticles.length - 1) {
      setCurrentIndex(currentIndex + 1);
    }
  };
    ...
    <>
      ...
      <div style={containerStyle}>
        ...
        <main className="electronics-main">
          <div key={iotArticles[currentIndex].id} style={articleContainerStyle} className="article-container">
            <h2 style={articleTitleStyle} className="article-title">
              {iotArticles[currentIndex].title}
            </h2>
            <p style={articleContentStyle} className="article-content">
              {iotArticles[currentIndex].content}
            </p>
          </div>
        </main>

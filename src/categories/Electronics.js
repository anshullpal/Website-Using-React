...
import electronicsArticles from './Posts/electronicsArticles';
...
const Electronics = () => {
  ...
  const handleNextClick = () => {
    if (currentIndex < electronicsArticles.length - 1) {
      setCurrentIndex(currentIndex + 1);
    }
  };
    ...
    <>
      ...
      <div style={containerStyle}>
        ...
        <main className="electronics-main">
          <div key={electronicsArticles[currentIndex].id} style={articleContainerStyle} className="article-container">
            <h2 style={articleTitleStyle} className="article-title">
              {electronicsArticles[currentIndex].title}
            </h2>
            <p style={articleContentStyle} className="article-content">
              {electronicsArticles[currentIndex].content}
            </p>
          </div>
        </main>

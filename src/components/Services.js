                        ...
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                    With over 3 years+ experience in content writing and web development and a deep understanding of the latest IT trends and solutions, we provide customized recommendations and strategies to help you improve your operations, reduce costs, and increase efficiency.
                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>We can collaborate with our comprehensive services include blog content writing, effective paid promotions, and the creation of articles on behalf of your esteemed customers, enhancing your digital presence and engagement.</p>
                            </div>
                        </div>
                    </div>
                </div>
